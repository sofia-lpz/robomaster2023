...
{
		//Este controla los motores 1,2,3,4
...
void CAN_cmd_chassis_good(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4)
{
		//Este controla los motores 1,2,3,4
...
void CAN_cmd_chassis(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4)
{
    ...
    uint32_t send_mail_box;
    chassis_tx_message.StdId = CAN_CHASSIS_ALL_ID;  //CAN_CHASSIS_ALL_ID
    chassis_tx_message.IDE = CAN_ID_STD;
    chassis_tx_message.RTR = CAN_RTR_DATA;
    chassis_tx_message.DLC = 0x08;
...
void CAN_cmd_gimbal_good(int16_t yaw, int16_t pitch, int16_t shoot, int16_t rev)
{
		//Este controla los motores 5,6,7,?
    uint32_t send_mail_box;
    gimbal_tx_message.StdId = CAN_CHASSIS_ALL_ID2;  //CAN_CHASSIS_ALL_ID2 se mueven pero al parecer todos
    gimbal_tx_message.IDE = CAN_ID_STD;
    gimbal_tx_message.RTR = CAN_RTR_DATA;
    gimbal_tx_message.DLC = 0x08;
    gimbal_can_send_data[0] = (yaw >> 8);
...
void CAN_cmd_feeder(int16_t yaw)
{
    uint32_t send_mail_box;
		/*
    chassis_tx_message.StdId = CAN_CHASSIS_ALL_ID2;
    ...
    chassis_tx_message.DLC = 0x08;
	  ...
	  chassis_can_send_data[0] = yaw >> 8;
    chassis_can_send_data[1] = yaw;
    chassis_can_send_data[2] = yaw >> 8;
    chassis_can_send_data[3] = yaw;
    chassis_can_send_data[4] = yaw >> 8;
    chassis_can_send_data[5] = yaw;
    chassis_can_send_data[6] = yaw >> 8;
    chassis_can_send_data[7] = yaw;
		*/
	  gimbal_tx_message.StdId = CAN_GIMBAL_ALL_ID;  //CAN_CHASSIS_ALL_ID2 se mueven pero al parecer todos
    gimbal_tx_message.IDE = CAN_ID_STD;
    gimbal_tx_message.RTR = CAN_RTR_DATA;
    gimbal_tx_message.DLC = 0x08;
    gimbal_can_send_data[0] = (yaw >> 8);
    gimbal_can_send_data[1] = yaw;
    gimbal_can_send_data[2] = (0 >> 8);
